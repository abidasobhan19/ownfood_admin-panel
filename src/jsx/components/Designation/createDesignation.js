...
const CreateDesignation = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/v1/get-designation")
      .then((res) => {
  ...
  const submit = () => {
    ...
    console.log(subdata);
    axios
      .post("http://localhost:5000/api/v1//create-designation", subdata)
      .then((res) => {
                            ...
                            <tr>
                              ...
                              <td>
                                <div className="d-flex align-items-center">
                                  ...
                                  <h5 className="mb-0">{item.status}</h5>
                                </div>
                              </td>
                            </tr>
                          );
